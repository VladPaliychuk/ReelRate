...
namespace Movie.DAL.Migrations
{
    ...
    [Migration("20250709104800_Initial_2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Movie.DAL.Entities.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Movie.DAL.Entities.RelationsEntities.FilmActor", b =>
                {
                    b.Property<Guid>("FilmId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Movie.DAL.Entities.RelationsEntities.FilmDirector", b =>
                {
                    b.Property<Guid>("FilmId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Movie.DAL.Entities.RelationsEntities.FilmGenre", b =>
                {
                    b.Property<Guid>("FilmId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Movie.DAL.Entities.Rating", b =>
                {
                    b.HasOne("Movie.DAL.Entities.Film", "Film")
                        .WithOne("Rating")
                        .HasForeignKey("Movie.DAL.Entities.Rating", "FilmId")
